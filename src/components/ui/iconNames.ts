...
export const ICONS = {
  ...
  swapVertical: { family: 'ionicons', name: 'swap-vertical' },
  bowl: { family: 'mci', name: 'bowl-mix' },
  target2: { family: 'mci', name: 'target' },
  seven: { family: 'mci', name: 'numeric-7-box' },
  trophy: { family: 'ionicons', name: 'trophy' },
  hand: { family: 'mci', name: 'hand-heart' },
  broom: { family: 'mci', name: 'broom' },
  berry: { family: 'mci', name: 'fruit-grapes' },
  clockOld: { family: 'mci', name: 'clock-time-eight' },
  ghost: { family: 'mci', name: 'ghost' },
  twins: { family: 'mci', name: 'account-multiple' },
  omega: { family: 'mci', name: 'omega' },
  trashBin: { family: 'mci', name: 'delete-variant' },
  speed: { family: 'mci', name: 'speedometer' },
  drumstick: { family: 'mci', name: 'food-drumstick' },
  grain: { family: 'mci', name: 'barley' },
  drop: { family: 'ionicons', name: 'water' },
  fiberLeaf: { family: 'mci', name: 'leaf' },
  candy: { family: 'mci', name: 'candy' },
  salt: { family: 'mci', name: 'shaker' },
  steps: { family: 'mci', name: 'walk' },
  run: { family: 'mci', name: 'run' },
  yoga: { family: 'mci', name: 'yoga' },
  bike: { family: 'mci', name: 'bike' },
  swim: { family: 'mci', name: 'swim' },
  dumbbell: { family: 'mci', name: 'dumbbell' },
  hiit: { family: 'mci', name: 'lightning-bolt' },
  cup: { family: 'mci', name: 'cup-water' },
  scale: { family: 'mci', name: 'scale-bathroom' },
  ruler: { family: 'mci', name: 'human-male-height' },
  hexagon: { family: 'mci', name: 'hexagon' },
  shieldBadge: { family: 'mci', name: 'shield' },
  starFour: { family: 'mci', name: 'star-four-points' },
  copy: { family: 'ionicons', name: 'copy' },
  sun: { family: 'ionicons', name: 'sunny' },
  phoneSettings: { family: 'ionicons', name: 'phone-portrait' },
  cameraOff: { family: 'mci', name: 'camera-off' },
  healthSync: { family: 'mci', name: 'heart-pulse' },
  weightHistory: { family: 'mci', name: 'history' },
  rings: { family: 'mci', name: 'circle-double' },
  stepsGoal: { family: 'mci', name: 'shoe-print' },
  gender: { family: 'mci', name: 'gender-male-female' },
  translate: { family: 'mci', name: 'translate' },
  crosshairs: { family: 'mci', name: 'crosshairs' },
  personRemove: { family: 'ionicons', name: 'person-remove' },
  personAdd: { family: 'ionicons', name: 'person-add' },
  coin: { family: 'mci', name: 'currency-usd' },
  asterisk: { family: 'mci', name: 'asterisk' },
  laptop: { family: 'ionicons', name: 'laptop' },
  mealPlan: { family: 'mci', name: 'clipboard-text' },
  birthday: { family: 'mci', name: 'cake-variant' },
  // status
